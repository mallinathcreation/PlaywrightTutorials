...
test('Browser Context Playwright test', async ({ browser }) => {
    ...
    //(**/*) => it represents any url.
    //(**/*.css) ==> it represents any url which is ending with .css. It is called as wildcard.
    await page.route("**/*.css", route => route.abort());
    //(**/*.{jpg,png,jpeg}) => it represents any url which is ending with .jpg or .png or .jpeg. It is called as wildcard.
    await page.route("**/*.{jpg,png,jpeg}", route => route.abort());
    //page will come with no css and jpg or png or jpeg images. It will come with broken UI but it will come faster as we are aborting the css and images.
    const username = page.locator('#username');
    const signInBtn = page.locator('#signInBtn');
    const cardTitles = page.locator('.card-body a');

    //to print all the request calls
